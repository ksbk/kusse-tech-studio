    ...
    if request.method == "POST":
        ...
        try:
            ...
            msg = Message(
                ...
                recipients=[
                    os.environ.get("BUSINESS_EMAIL", "contact@kussetechstudio.com")
                ],
                body=f"""
...
Thank you for your message! I have received your inquiry and will get back to you within
24 hours.
...
Python Development & Data Automation
            ...
            if current_app.config.get("MAIL_USERNAME"):
                ...
                flash(
                    ...
                    "successfully. You should receive a confirmation "
                    "email shortly.",
                    "success",
                )
            else:
                ...
                flash(
                    ...
                    "(Email not configured in development)",
                    "info",
                )
            ...
            flash(
                "Thank you for your message! There was an issue with "
                "email delivery, but your message has been recorded.",
                "warning",
            )
