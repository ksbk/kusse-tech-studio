...
class AdvancedThemeManager {
  ...
  updateThemeSelector() {
    ...
    const mobileThemeOptions = document.querySelectorAll(
      ".mobile-theme-option",
    );
  ...
  setTheme(themeName) {
    if (
      this.customThemes.has(themeName) ||
      ["auto", "light", "dark"].includes(themeName)
    ) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.getAvailableThemes = () =>
    Array.from(window.themeManager.customThemes.keys());
